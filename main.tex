...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			plot [:600][260:440] 	'Data/Shear/C30/1.0GPa/10m_s/e2e2.plot_s.plot'  u  (($1/1e6)*10):($2) w l  lw 3   lt 3 pt 3 notitle  , 'Data/Shear/C30/1.0GPa/10m_s2/e2e2.plot_s.plot'  u (($1/1e6)*10):($2) w l  lw 3    lt 3 pt 3 notitle ,\
								'Data/Shear/C30/1.0GPa/20m_s/e2e2.plot_s.plot'  u  (($1/1e6)*20):($2) w l  lw 3   lt 4 pt 4 notitle  , 'Data/Shear/C30/1.0GPa/20m_s2/e2e2.plot_s.plot'  u (($1/1e6)*20):($2) w l  lw 3    lt 4 pt 4 notitle ,\
								'Data/Shear/C30/1.0GPa/50m_s/e2e2.plot_s.plot'   u (($1/1e6)*50):($2) w l  lw 3   lt 5 pt 5 notitle  , 'Data/Shear/C30/1.0GPa/50m_s2/e2e2.plot_s.plot' u  (($1/1e6)*50):($2) w l  lw 3    lt 5 pt 5 notitle ,\
								'Data/Shear/C30/1.0GPa/100m_s/e2e2.plot_s.plot' u  (($1/1e6)*100):($2) w l  lw 3   lt 10 pt 10 notitle  , 'Data/Shear/C30/1.0GPa/100m_s2/e2e2.plot_s.plot' u (($1/1e6)*100):($2) w l  lw 3   lt 10 pt 10  notitle 
			...
			plot  [:600][0.28:0.65]	'Data/Shear/C30/1.0GPa/10m_s/P2XZ_s.plot' u   (($1/1e6)*10):($2) w l lw 3 lt 3 pt 3 title '' , 'Data/Shear/C30/1.0GPa/10m_s2/P2XZ_s.plot' u   (($1/1e6)*10):($2) w l lw 3  lt 3 pt 3 notitle  ,\
								'Data/Shear/C30/1.0GPa/20m_s/P2XZ_s.plot' u   (($1/1e6)*20):($2) w l  lw 3  lt 4 pt 4 title '' , 'Data/Shear/C30/1.0GPa/20m_s2/P2XZ_s.plot' u   (($1/1e6)*20):($2) w l  lw 3  lt 4 pt 4 notitle  ,\
								'Data/Shear/C30/1.0GPa/50m_s/P2XZ_s.plot' u  (($1/1e6)*50):($2) w l  lw 3   lt 5 pt 5 title '' , 'Data/Shear/C30/1.0GPa/50m_s2/P2XZ_s.plot' u  (($1/1e6)*50):($2) w l  lw 3   lt 5 pt 5 notitle ,\
								'Data/Shear/C30/1.0GPa/100m_s/P2XZ_s.plot' u  (($1/1e6)*100):($2) w l  lw 3  lt 10 pt 10 title '' , 'Data/Shear/C30/1.0GPa/100m_s2/P2XZ_s.plot' u (($1/1e6)*100):($2) w l  lw 3  lt 10 pt 10 notitle 
			...
			plot  [:600][40:150]	'Data/Shear/C30/1.0GPa/10m_s/fc_ave.dump.plot' u (($1/1e6)*10):($2/10) w l  lw 3    lt 3 pt 3 notitle  ,                           'Data/Shear/C30/1.0GPa/10m_s2/fc_ave.dump.plot' u (($1/1e6)*10):($2/10) w l  lw 3     lt 3 pt 3 title  "\\SI{10}{\\meter\\per\\second}"   ,\
							'Data/Shear/C30/1.0GPa/20m_s/fc_ave.dump.plot' u (($1/1e6)*20):($2/10) w l  lw 3    lt 4 pt 4 notitle  , 'Data/Shear/C30/1.0GPa/20m_s2/fc_ave.dump.plot' u (($1/1e6)*20):($2/10) w l  lw 3     lt 4 pt 4 title  "\\SI{20}{\\meter\\per\\second}"   ,\
							'Data/Shear/C30/1.0GPa/50m_s/fc_ave.dump.plot' u (($1/1e6)*50):($2/10) w l  lw 3     lt 5 pt 5 notitle  , 'Data/Shear/C30/1.0GPa/50m_s2/fc_ave.dump.plot'  u (($1/1e6)*50):($2/10)  w l  lw 3   lt 5 pt 5 title  "\\SI{50}{\\meter\\per\\second}"  ,\
							'Data/Shear/C30/1.0GPa/100m_s/fc_ave.dump.plot' u (($1/1e6)*100):($2/10) w l  lw 3   lt 10 pt 10 notitle  , 'Data/Shear/C30/1.0GPa/100m_s2/fc_ave.dump.plot'  u (($1/1e6)*100):($2/10) w l  lw 3   lt 10 pt 10 title  "\\SI{100}{\\meter\\per\\second}"  
...
\begin{figure}[h]
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			plot  	[][-6:6]  'Data/Shear/C16/0.5GPa/10m_s_cont2/fluid_mdp_z_s.dump' u ($2-39.9):($4) w l  lt 1 axes x1y2,\
				              'Data/Shear/C16/0.5GPa/10m_s_cont2/vel_prof_x_s.dump'  u (bin($2-39.9,binwidth)):($4*100) smooth unique lt 1 dashtype 4 lw 3,\	
                              'Data/Shear/C60/0.5GPa/10m_s_cont2/fluid_mdp_z_s.dump' u ($2-37.28):($4) w l  lt 3  axes x1y2,\
				              'Data/Shear/C60/0.5GPa/10m_s_cont2/vel_prof_x_s.dump'  u (bin($2-37.28,binwidth)):($4*100) smooth unique lt 3 dashtype 4 lw 3
		\end{gnuplot}
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			binwidth=2
			bin(x,width)=width*floor(x/width)
			...
			plot  	[][-60:60]  'Data/Shear/C16/0.5GPa/100m_s_cont/fluid_mdp_z_s.dump' u ($2-42.7):($4) w l  lt 1 axes x1y2,\
				              'Data/Shear/C16/0.5GPa/100m_s_cont/vel_prof_x_s.dump'  u (bin($2-42.7,binwidth)):($4*100) smooth unique lt 1 dashtype 4  lw 3,\
                              'Data/Shear/C60/0.5GPa/100m_s_cont2/fluid_mdp_z_s.dump' u ($2-40.11):($4) w l  lt 3  axes x1y2,\
				              'Data/Shear/C60/0.5GPa/100m_s_cont2/vel_prof_x_s.dump'  u (bin($2-40.11,binwidth)):($4*100) smooth unique lt 3 dashtype 4  lw 3
		\end{gnuplot}
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			binwidth=4
			bin(x,width)=width*floor(x/width)
			...
			plot  	[][-6:6]  'Data/Shear/C16/1.5GPa/10m_s_cont/fluid_mdp_z_s.dump' u ($2-35.9):($4) w l  lt 1 axes x1y2,\
				              'Data/Shear/C16/1.5GPa/10m_s_cont/vel_prof_x_s.dump'  u (bin($2-35.9,binwidth)):($4*100) smooth unique lt 1 dashtype 4  lw 3,\	
                              'Data/Shear/C60/1.5GPa/10m_s_cont2/fluid_mdp_z_s.dump' u ($2-34.5):($4) w l  lt 3  axes x1y2,\
				              'Data/Shear/C60/1.5GPa/10m_s_cont2/vel_prof_x_s.dump'  u (bin($2-34.5,binwidth)):($4*100) smooth unique lt 3 dashtype 4  lw 3
		\end{gnuplot}
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
		set key top center
			binwidth=2
			...
			plot  	[][-60:60]  'Data/Shear/C16/1.5GPa/100m_s_cont/fluid_mdp_z_s.dump' u ($2-38.2):($4) w l  lt 1 axes x1y2 title "C16",\
				              'Data/Shear/C16/1.5GPa/100m_s_cont/vel_prof_x_s.dump'  u (bin($2-38.2,binwidth)):($4*100) smooth unique lt 1 dashtype 4  lw 3,\
                              'Data/Shear/C60/1.5GPa/100m_s_cont2/fluid_mdp_z_s.dump' u ($2-36.25):($4) w l  lt 3  axes x1y2 title "C60",\
				              'Data/Shear/C60/1.5GPa/100m_s_cont2/vel_prof_x_s.dump'  u (bin($2-36.25,binwidth)):($4*100) smooth unique lt 3 dashtype 4  lw 3
		\end{gnuplot}
...
A representative example of transient deviations from Couette flow at the onset of shear is shown for $C_{30}$, \SI{1.0}{\giga\pascal} and  \SI{50}{\meter\per\second} in Figure \ref{fig:VelProf_MDP}. Most systems eventually show Couette flow, but non-linear flow persists into the steady state for some of the systems and consitions studied (Figure \ref{fig:VelProf_MDP2}).
