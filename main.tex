...
The last criterion, is based on the fact that systems of long chain alkanes are not properly equilibrated and can present deformation on short length scales, and this deformation is only relaxed after the chains have moved at least their own size\cite{Auhl2003}. In order to verify this, the mean squared displacement per atom $\left(\text{MSD}_{\text{atom}}\right)$ and per centre of mass of alkane chain $\left(\text{MSD}_{\text{CG}}\right)$ are followed during equilibration. 
...
%Equilibrium is reached via the movement and reorganisation in layers of the alkane chains. The chains close to the walls form a clear layered structure, while those further away from the walls are not as well organised and in the centre of the film a central amorphous-like region is evident. The formation of the amorphous regions is due to the fact that it is more difficult for longer chains to diffuse and find a more ordered and energetically favourable configuration, especially at higher pressures; this results, concurrently, in  higher densities for longer chains (see Table \ref{tab:rho}). Note that this is in contrast with the behaviour of atomic fluids, which have the tendency to form more ordered structures when subjected to higher pressures\cite{Gattinoni2013}.
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set ylabel "$\\left<P_{2}^{xz}\\right>$"
			set key noautotitle
			p [:110][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($8):($9) w errorbars  title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($8):($9) w errorbars title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($8) w l notitle lt 2 lc 1  lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($8):($9) w errorbars title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($8) w l notitle lt 3 lc 1 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($8):($9) w errorbars notitle lt 1 lc 0 ps 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($8) w l title "C16" lt 1 lc 1 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($8) w l title "C30" lt 1 lc 2 lw 2 ,\				
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($8) w l notitle lt 2 lc 2 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($8):($9) w errorbars notitle lt 2 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($8) w l notitle lt 3 lc 2 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($8):($9) w errorbars notitle lt 3 lc 0 ps 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($8):($9) w errorbars notitle lt 1 lc 0 ps 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($8) w l title 'C60' lt 1 lc 3 lw 2 ,\				
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set ylabel "$F_L \\, [\\SI{}{\\mega\\pascal}]$"
			set key noautotitle
			p [:110][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($4):($5) w p title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($4):($5) w p title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($4) w l notitle lt 2 lc 1  lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($4):($5) w p title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($4) w l notitle lt 3 lc 1 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($4):($5) w p notitle lt 1 lc 0 ps 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($4) w l title "C16" lt 1 lc 1 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($4) w l title "C30" lt 1 lc 2 lw 2 ,\				
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($4) w l notitle lt 2 lc 2 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($4):($5) w p notitle lt 2 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($4) w l notitle lt 3 lc 2 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($4):($5) w p notitle lt 3 lc 0 ps 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($4):($5) w p notitle lt 1 lc 0 ps 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($4) w l title 'C60' lt 1 lc 3 lw 2 ,\				
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set format x  '$10^{%L}$' 
			set logscale x
			p [:2e10][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($4):($5) w p title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($4):($5) w p title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($4) w l notitle lt 2 lc 1  lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($4):($5) w p title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($4) w l notitle lt 3 lc 1 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($4):($5) w p notitle lt 1 lc 0 ps 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($4) w l title "C16" lt 1 lc 1 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($4) w l title "C30" lt 1 lc 2 lw 2 ,\				
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($4) w l notitle lt 2 lc 2 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($4):($5) w p notitle lt 2 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3/($12*1e-10)):($4) w l notitle lt 3 lc 2 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3/($12*1e-10)):($4):($5) w p notitle lt 3 lc 0 ps 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3/($12*1e-10)):($4):($5) w p notitle lt 1 lc 0 ps 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3/($12*1e-10)):($4) w l title 'C60' lt 1 lc 3 lw 2 ,\				
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 7 u ($3/($12*1e-10)):($4) w l notitle  lt 2 lc 3 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 7 u ($3/($12*1e-10)):($4):($5) w p notitle  lt 2 lc 0 ps 2,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 8 u ($3/($12*1e-10)):($4) w l notitle  lt 3 lc 3 lw 2 ,\
				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 8 u ($3/($12*1e-10)):($4):($5) w p notitle  lt 3 lc 0 ps 2,\
		\end{gnuplot}
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set ylabel "$\\mu$"
			set key noautotitle
			p [:110][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($4/($2*1000)) w p title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($4/($2*1000)) w p title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($4/($2*1000)) w l notitle lt 2 lc 1  lw 2 ,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($4/($2*1000)) w p title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($4/($2*1000)) w l notitle lt 3 lc 1 lw 2 ,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($4/($2*1000)) w p notitle lt 1 lc 0 ps 2 ,\
        				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($4/($2*1000)) w l title "C16" lt 1 lc 1 lw 2 ,\
		        		'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($4/($2*1000)) w l title "C30" lt 1 lc 2 lw 2 ,\				
				        'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($4/($2*1000)) w l notitle lt 2 lc 2 lw 2 ,\
				        'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($4/($2*1000)) w p notitle lt 2 lc 0 ps 2,\
        				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($4/($2*1000)) w l notitle lt 3 lc 2 lw 2 ,\
		        		'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($4/($2*1000)) w p notitle lt 3 lc 0 ps 2 ,\
				        'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($4/($2*1000)) w p notitle lt 1 lc 0 ps 2 ,\
        				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($4/($2*1000)) w l title 'C60' lt 1 lc 3 lw 2 ,\				
		        		'Data/Shear/Compiled_e2e2_v.plot8.plot' i 7 u ($3):($4/($2*1000)) w l notitle  lt 2 lc 3 lw 2 ,\
				        'Data/Shear/Compiled_e2e2_v.plot8.plot' i 7 u ($3):($4/($2*1000)) w p notitle  lt 2 lc 0 ps 2,\
        	   			'Data/Shear/Compiled_e2e2_v.plot8.plot' i 8 u ($3):($4/($2*1000)) w l notitle  lt 3 lc 3 lw 2 ,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 8 u ($3):($4/($2*1000)) w p notitle  lt 3 lc 0 ps 2,\
		\end{gnuplot}
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set format x  '$10^{%L}$' 
			set logscale x
			p [:2e10][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($4/($2*1000)) w p title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($4/($2*1000)) w p title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($4/($2*1000)) w l notitle lt 2 lc 1  lw 2 ,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($4/($2*1000)) w p title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($4/($2*1000)) w l notitle lt 3 lc 1 lw 2 ,\
			        	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($4/($2*1000)) w p notitle lt 1 lc 0 ps 2 ,\
        				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($4/($2*1000)) w l title "C16" lt 1 lc 1 lw 2 ,\
		        		'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($4/($2*1000)) w l title "C30" lt 1 lc 2 lw 2 ,\				
				        'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($4/($2*1000)) w l notitle lt 2 lc 2 lw 2 ,\
				        'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($4/($2*1000)) w p notitle lt 2 lc 0 ps 2,\
        				'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3/($12*1e-10)):($4/($2*1000)) w l notitle lt 3 lc 2 lw 2 ,\
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set key noautotitle
			set logscale xy
			p [:2e10][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l notitle lt 2 lc 1  lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l notitle lt 3 lc 1 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p notitle lt 1 lc 0 ps 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l title "C16" lt 1 lc 1 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l title "C30" lt 1 lc 2 lw 2 ,\				
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l notitle lt 2 lc 2 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p notitle lt 2 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l notitle lt 3 lc 2 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p notitle lt 3 lc 0 ps 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p notitle lt 1 lc 0 ps 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l title 'C60' lt 1 lc 3 lw 2 ,\				
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 7 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l notitle  lt 2 lc 3 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 7 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p notitle  lt 2 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 8 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))) w l notitle  lt 3 lc 3 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 8 u ($3/($12*1e-10)):($4*1e6/($3/($12*1e-10))):($5*1e6/($3/($12*1e-10))) w p notitle  lt 3 lc 0 ps 2,\
		\end{gnuplot}
...
From the temperature measurements made during steady state presented in Figure  \ref{fig:T_P} we note that higher shearing velocities and higher pressures are accompanied by an increase in the temperature of the lubricant. 
...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set key noautotitle
			set logscale x
			p [:2e10][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3/($12*1e-10)):($10) w p title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($10) w p title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3/($12*1e-10)):($10) w l notitle lt 2 lc 1  lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($10) w p title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 2,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3/($12*1e-10)):($10) w l notitle lt 3 lc 1 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3/($12*1e-10)):($10) w p notitle lt 1 lc 0 ps 2 ,\
					...
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3/($12*1e-10)):($10) w p notitle lt 2 lc 0 ps 2,\
