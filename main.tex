...
\begin{figure}
		...
		\begin{gnuplot}[terminal=pdf, terminaloptions={size \SERFigwidth cm, \SERFigheight cm color solid}]
			...
			set ylabel "$\\left<P_{2}^{xz}\\right>$"
			set key noautotitle
			p [:110][]	'Data/Shear/Compiled_e2e2_v.plot8.plot' i 0 u ($3):($8):($9) w errorbars  title "$\\SI{0.5}{\\giga\\pascal}$" lt 1 lc 0 ps 1,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($8):($9) w errorbars title  "$\\SI{1.0}{\\giga\\pascal}$" lt 2 lc 0 ps 1,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 1 u ($3):($8) w l notitle lt 2 lc 1  lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($8):($9) w errorbars title  "$\\SI{1.5}{\\giga\\pascal}$" lt 3 lc 0 ps 1,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 2 u ($3):($8) w l notitle lt 3 lc 1 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 3 u ($3):($8):($9) w errorbars notitle lt 1 lc 0 ps 1 ,\
					...
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 4 u ($3):($8):($9) w errorbars notitle lt 2 lc 0 ps 1,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($8) w l notitle lt 3 lc 2 lw 2 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 5 u ($3):($8):($9) w errorbars notitle lt 3 lc 0 ps 1 ,\
					'Data/Shear/Compiled_e2e2_v.plot8.plot' i 6 u ($3):($8):($9) w errorbars notitle lt 1 lc 0 ps 1 ,\
