...
A comprehensive understanding of the behaviour of fluids confined and sheared between solid surfaces is important to a range of fields and in particular tribology. In the present study, the behaviour of linear alkanes confined and sheared between iron oxide surfaces have been investigated under thin film lubrication conditions. The effect of the alkane chain length (C16 - C60) as well as the applied pressure (0.5 - 1.5 GPa) and the sliding velocity (10 - 100 m/s) have been studied. The shear stress always increases with increasing alkane chain length; however, the difference becomes smaller at high sliding velocity. This is because, while short alkanes show the common increase with sliding velocity, long chains show a decrease due to shear-induced melting.

\section{Introduction}

The behaviour of fluids confined and sheared between solid surfaces is of broad technological interest, from polymer processing to microfluidic devices. A detailed understanding of confined fluid behaviour is particularly critical in tribology, where lubricants are entrained into the contact to generate a film to separate the sliding surfaces to minimise friction and wear.

In order to reduce hydrodynamic losses, there has been a progressive reduction in lubricant viscosity; however, this means that thinner films separate the sliding surfaces. Thin film lubrication (TFL) describes a lubrication regime when the lubricant film ranges from a few nanometers to tens of nanometers; i.e. between boundary lubrication and elastohydrodynamic lubrication (EHL)\cite{Wang2013a}. The behaviour of lubricants under nanoconfinement remains unclear, and is ideally suited to study by nonequilibrium molecular dynamics (NEMD) simulations \cite{Ewen2017a}. Since the early 1990s, many studies have investigated the behaviour of lubricants strongly confined (< 6 molecular layers) between solid surfaces \cite{Ewen2018}, where confinement is known to strongly affect viscosity \cite{Granick1990}. NEMD simulations suggested that this viscosity increase was due to vitrification to a glassy state (atomic fluid) or even crystallization (chain) \cite{Thompson1992}. Early NEMD simulations of atomic fluids suggested that, under such conditions, lubricant viscosity deviates significantly from bulk values \cite{Bitsanis1990}. Moreover, NEMD simulations of simple model lubricants under such conditions showed flow behaviour which deviated from Couette predictions such as slip at the solid-lubricant interface as well as between molecular layers in the lubricant film \cite{Thompson1990}. Long, linear alkanes have also been studied under strong confinement at shear. For metal-like surfaces at high sliding velocities (100 m/s), the shear stress was found to be relatively independent
of molecular length between C20 and C1400 \cite{Sivebaek2008}. For the same chain lengths, it was also found that the shear stress was shown to increase monotonically with the sliding velocity \cite{Sivebaek2010}. It was also found that linear C20 molecules melt under shear, whereas longer chains only showed a softening transition \cite{Sivebaek2012}.

Fewer NEMD studies have investigated the behaviour of slightly thicker lubricant films (> 6 molecular layers) of direct relevance to TFL. NEMD simulations \cite{Thompson1992,Robbins1996} and experiments \cite{VanAlsten1988} suggested that there were similarities between the behaviour of strongly confined films and thicker films under high pressure. Comprehensive NEMD simulations of relatively thick Lennard-Jones (LJ) fluid films showed that LJ fluids give different but well defined phases depending on the external constraints (velocity and pressure), a behaviour that can be well described by a nonequilibrium phase diagram \cite{Heyes2012}. It was also found that single component LJ liquids form semicrystalline arrangements and behave more like traction fluids, while binary mixtures discourages crystallization and give a more classical tribological response, closer to that of lubricants \cite{Gattinoni2013}. Another study found that, due to the nonequilibrium phase adopted by fluid, the friction coefficient does not necessarily echo the classical friction relations between macroscopic bodies \cite{Mackowiak2016}. More recently, similar nonequilibrium phase behaviour has been observed in NEMD simulations of more realistic lubricant and traction fluid molecules at high pressure \cite{Ewen2017a}.

In the present study, the behaviour of linear alkanes confined and sheared between iron oxide surfaces have been investigated under TFL conditions. The effect of the alkane chain length (C16 - C60) as well as the applied pressure (0.5 - 1.5 GPa) and the sliding velocity (10 - 100 m/s) have been studied.
